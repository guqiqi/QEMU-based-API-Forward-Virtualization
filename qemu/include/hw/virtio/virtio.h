...
// block of logical buffer
typedef struct VirtQueueElement
{
    unsigned int index;
    unsigned int len;
    unsigned int ndescs;
    unsigned int out_num;   // number of output blocks
    unsigned int in_num;    // number of input blocks
    hwaddr *in_addr;        // physical address
    hwaddr *out_addr;
    struct iovec *in_sg;    // virtual address in guest, mapping of physical to virtual
    struct iovec *out_sg;
} VirtQueueElement;
